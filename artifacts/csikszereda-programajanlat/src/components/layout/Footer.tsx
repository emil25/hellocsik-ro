...
export function Footer() {
  ...
  return <footer className="bg-background">
    ...
    <div className="max-w-7xl mx-auto px-5 sm:px-8 py-5 border-t border-border text-sm text-muted-foreground">© {new Date().getFullYear()} HelloCsík · Csíkszereda és a Csíki-medence <p className="mt-2 text-xs"><a className="underline" href="https://commons.wikimedia.org/wiki/File:RO_HR_Miercurea_Ciuc_Miko_castle.jpg" target="_blank" rel="noreferrer">Várfotó: Andrei Stroe / Wikimedia Commons</a> · <a className="underline" href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank" rel="noreferrer">CC BY-SA 3.0</a> · Vágott kép</p></div>
  </footer>;
}
