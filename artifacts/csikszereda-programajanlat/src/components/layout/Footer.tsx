...
export function Footer() {
  ...
  return <footer className="bg-background">
    ...
    <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 flex flex-wrap items-center justify-between gap-6">
      <div><Link href="/" className="text-2xl font-extrabold tracking-tight">hellocsík<span className="text-primary">.ro</span></Link><p className="text-sm text-muted-foreground mt-2">Székelyföldi programok. Közös élmények.</p></div>
    ...
    <div className="max-w-7xl mx-auto px-5 sm:px-8 py-5 border-t border-border text-sm text-muted-foreground">© {new Date().getFullYear()} HelloCsík · Székelyföld: Hargita, Kovászna és Maros megye <p className="mt-2 text-xs"><a className="underline" href="https://commons.wikimedia.org/wiki/File:RO_HR_Miercurea_Ciuc_center_1.jpg" target="_blank" rel="noreferrer">Fotó: Andrei Stroe / Wikimedia Commons</a> · <a className="underline" href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank" rel="noreferrer">CC BY-SA 3.0</a> · Vágott kép</p></div>
  </footer>;
}
